...
export default function ApplicationsFeedParams({params, setParams, clearParams}) {
      ...
      <div>
        <FormControl className='w-48'>
          ...
          >
            ...
            <MenuItem value={'application_date'}>Submitted at</MenuItem>
...
ApplicationsFeedParams.propTypes = {
